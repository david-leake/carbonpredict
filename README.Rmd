...
Carbon Predict is an R package for predicting Scope 1, 2 and 3 carbon emissions for UK SMEs using SIC codes and annual turnover data. It provides batch prediction, plotting, and workflow tools for carbon accounting and reporting.
